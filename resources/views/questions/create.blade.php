                    ...
                    <div>
                        ...
                        <div class="block mt-2">
                            <label for="is_correct1" class="inline-flex items-center">
                                <input id="is_correct1" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_correct[]" value="0" >
                    ...
                    <div>
                        ...
                        <div class="block mt-2">
                            <label for="is_correct2" class="inline-flex items-center">
                                <input id="is_correct2" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_correct[]" value="1" >
                                <span class="ml-2 text-sm text-gray-600">{{ __('Está correta?') }}</span>
                            </label>
                        </div> 
                    </div>
                    <div>
                        ...
                        <div class="block mt-2">
                            <label for="is_correct3" class="inline-flex items-center">
                                <input id="is_correct3" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_correct[]" value="2" >
                                <span class="ml-2 text-sm text-gray-600">{{ __('Está correta?') }}</span>
                            </label>
                        </div> 
                    </div>
                    <div>
                        ...
                        <div class="block mt-2">
                            <label for="is_correct4" class="inline-flex items-center">
                                <input id="is_correct4" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_correct[]" value="3" >
                                <span class="ml-2 text-sm text-gray-600">{{ __('Está correta?') }}</span>
                            </label>
                        </div> 
                    </div>
