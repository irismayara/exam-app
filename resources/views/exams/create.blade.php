        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('exam.store') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="datetime_start" class="block mt-1 w-full" type="datetime-local" name="datetime_start" :value="old('datetime_start')" required />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="datetime_end" class="block mt-1 w-full" type="datetime-local" name="datetime_end" :value="old('datetime_end')" required />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="time" class="block mt-1 w-full" type="number" name="time" :value="old('time')" required autofocus />
